...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                <!-- Navbar -->
                <?php $pagetitle = "Channel Partner Lists";
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center filter-bar">
                                                <div class="d-flex align-items-center">
                                                    <!-- <label class="btn btn-sm btn-listtype checked"><input type="radio"
                                                            name="filtertype" class="d-none" value="statuswise"
                                                            checked /><i
                                                            class="fas fa-align-left rotate-90"></i></label> -->
                                                    <label class="btn btn-sm btn-listtype"><input type="radio"
                                                            name="filtertype" class="d-none" value="alllist" /><i
    ...
    <script src="<?php echo $baseurl ?>assets/js/bind/lead/confirmcplist.js?v=<?php echo $ver ?>"></script>
</body>
