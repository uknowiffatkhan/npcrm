                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-2">
                                                    ...
                                                    <div>
                                                        <input type="hidden" name="leadtype" value="2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-2">
                                                    ...
                                                    <div>
                                                        <input type="hidden" name="poldaddress" value="<?php echo isset($det) ? $det["Ld_Permanent_add"] : "" ?>">
                                                        <input type="text" name="paddress"
                                                            value="<?php echo isset($det) ? $det["Ld_Permanent_add"] : "" ?>"
                                                            class="form-control form-control-sm" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="leadstatus" class="form-control form-control-sm" <?php echo isset($det) ? "data-selected=" . $det["Ld_LeadStatus"] . "" : "" ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="mb-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="project" class="form-control form-control-sm" <?php echo isset($det) ? "data-selected=" . $det["Ld_ProjectId"] . "" : "" ?>>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-2">
                                                    ...
                                                    <div>
                                                        <input type="hidden" name="oldrerano" value="<?php echo isset($det) ? $det["Ld_Rera_Number"] : "" ?>">
                                                        <input type="text" name="rno"
                                                            value="<?php echo isset($det) ? $det["Ld_Rera_Number"] : "" ?>"
                                                            class="form-control form-control-sm" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="mb-2">
                                                    <label>Gst No</label>
                                                    <div>
                                                        <input type="hidden" name="oldgst" value="<?php echo isset($det) ? $det["Ld_Gst_No"] : "" ?>">
                                                        <input type="text" name="gst"
                                                            value="<?php echo isset($det) ? $det["Ld_Gst_No"] : "" ?>"
                                                            class="form-control form-control-sm" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-end">
                                            <div>
                                                ...
                                                <?php endif; ?>
                                                <input type="hidden" name="mode" value="<?php echo isset($det) ? "updatesourcinglead" : "insertsourcinglead" ?>" />
                                                <button type="button" class="btn btn-transparent text-danger">Cancel</button>
                                                <button type="submit" value="true" name="submit" class="btn btn-info">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
